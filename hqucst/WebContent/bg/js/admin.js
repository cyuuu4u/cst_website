    ...
    var items = [
        {
            ...
            children: [{
                text: '学院概况',
                href: 'goto.action?a=document&id='+1
            }, {
                text: '教学工作',
                href: 'goto.action?a=document&id='+2
            }, {
                text: '师资队伍',
                href: 'goto.action?a=document&id='+3
            }, {
                text: '院务工作',
                href: 'goto.action?a=document&id='+4
            }, {
                text: '学术科研',
                href: 'goto.action?a=document&id='+5
            },{
                text: '研究生教学',
                href: 'goto.action?a=document&id='+6
            },{
                text: '教师个人简介',
                href: 'goto.action?a=teacher'
            }]
        },{
            title: '系统管理',
            iconCls: 'icon-caption',
